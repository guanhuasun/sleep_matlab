...
h_ini=0.045*ones(N_neuron,1);
n_ini=0.54*ones(N_neuron,1);
m_ini=0.34*ones(N_neuron,1);

c_Ca_ini=1+9*rand(N_neuron,1);


s_AMPA_ini=0.05+zeros(N_neuron,1);
s_NMDA_ini=0.05+zeros(N_neuron,1);
x_NMDA_ini=0.05+zeros(N_neuron,1);
s_GABA_ini=0.05+zeros(N_neuron,1);

x=[v_ini, m_ini, h_ini, n_ini, c_Ca_ini, s_AMPA_ini,s_NMDA_ini,x_NMDA_ini,s_GABA_ini];
